...
| **Agent Gateway** | `agent-gw.beeos.ai` | Agent pods (you don't call this directly) | Ed25519-signed agent identity | Agents call inward for file presign, messaging tokens, A2A |
...
flowchart LR
    ...
    AgentPod["Agent Pod"] -->|"Ed25519"| AgentGW["agent-gw.beeos.ai"]
