...
<Note>
Building a LangChain or LangGraph application? `langchain-beeos` builds on the
public `beeos` package and exposes its instance, Agent, computer, and mobile
operations as typed tools. See [LangChain and LangGraph](/integrations/langchain).
</Note>
