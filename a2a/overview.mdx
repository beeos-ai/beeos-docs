...
For the exact mapping between A2A task states, OpenAPI task
statuses, message envelopes, and runtime operations, see
[Task and operation states](/guides/task-lifecycle).
