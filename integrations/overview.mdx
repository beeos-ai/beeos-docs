...
description: Connect coding agents, Agent harnesses, automation platforms, and A2A clients to BeeOS.
---
...
<CardGroup cols={2}>
  <Card title="BeeOS Skills" icon="puzzle-piece" href="/integrations/beeos-skills">
    Install the official multi-host plugin for Codex, Claude Code, Cursor, Hermes, OpenClaw, and more.
  </Card>
  <Card title="DeepSeek Harness" icon="code" href="/integrations/deepseek-harness">
    Mount native BeeOS OpenAPI tools for instances, tasks, computers, and mobile devices.
  </Card>
  ...
  <Card title="LangChain and LangGraph" icon="share-nodes" href="/integrations/langchain">
    Use typed BeeOS tools in agents and graphs with explicit safety boundaries.
  </Card>
